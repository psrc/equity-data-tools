...
census.tables <- list("B02001.1yr" = list("B02001","Race", "acs/acs1"),
                      "B05002.5yr" = list("B05002","Place of Birth by Nativity and Citizenship asian", "acs/acs5"),
                      "B05003.5yr" = list("B05003","Place of Birth  Native Hawaiian Pacific Islander", "acs/acs5"),
                      "B08105A.5yr" = list("B08105A","Means of Transportation to Work White Alone", "acs/acs5"),
                      "B08105B.5yr" = list("B08105B","Means of Transportation to Work Black Alone", "acs/acs5"),
                      ...
                      "B06004E.5yr" = list("B06004E","Place of Birth in the US pacific islander", "acs/acs5"),
                      ...
                      "B02016.5yr" = list("B02016","NATIVE HAWAIIAN AND OTHER PACIFIC ISLANDER ALONE BY SELECTED GROUPS", "acs/acs5"),
